...
## Estado actual: implementado (Sprint 14) + imágenes con Cloudinary (Sprint 15)
...
Ver las fichas completas de estos sprints en [SPRINT-14](./sprints/SPRINT-14.md) y [SPRINT-15](./sprints/SPRINT-15.md).
