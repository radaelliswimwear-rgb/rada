...
| 14     | Panel Administrativo (base): productos, pedidos, usuarios; `User.role` wireado de punta a punta                | [SPRINT-14](./sprints/SPRINT-14.md)     |
...
- **Completar el Panel Administrativo** — el Sprint 14 construyó la base (productos, pedidos, usuarios, dashboard); falta Cloudinary para imágenes, edición de categorías, paginación si el catálogo crece, y una entrada visible en el Navbar para administradores — ver [ADMIN_PANEL.md](./ADMIN_PANEL.md).
