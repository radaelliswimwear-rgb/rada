...
- **Completar el Panel Administrativo** — los Sprints 14/15/17 construyeron productos (con imágenes vía Cloudinary), categorías (rename), inventario, pedidos, usuarios, dashboard, blog, newsletter y cupones, con buscador y paginación, y ya tiene entrada visible en el Navbar/menú de cuenta; falta CRUD completo de categorías (exige rutas dinámicas) y buscador/paginación server-side si el volumen crece mucho más — ver [ADMIN_PANEL.md](./ADMIN_PANEL.md).
