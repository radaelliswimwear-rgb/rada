...
- ~~Integrar Cloudinary~~ para imágenes de producto — ✅ hecho (Sprint 15); las 20 imágenes sembradas desde Unsplash siguen intactas, Cloudinary aplica a las subidas nuevas desde el panel. Pendiente confirmar que `CLOUDINARY_CLOUD_NAME` en producción sea válido (ver [SPRINT-15](./sprints/SPRINT-15.md)).
