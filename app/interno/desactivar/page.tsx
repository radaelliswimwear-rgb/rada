...
import { DeactivateInternalTrafficPanel } from "components/internal-traffic/deactivate-internal-traffic-panel";
import Footer from "components/layout/footer";

export const metadata: Metadata = {
  title: "Desactivar tráfico interno",
  robots: { index: false, follow: false },
};

export default function DesactivarTraficoInternoPage() {
  return (
    <>
      <div className="mx-auto flex min-h-[70vh] max-w-md flex-col items-center justify-center px-4 py-16">
        ...
        <div className="mt-8 w-full rounded-2xl border border-neutral-200 p-6 dark:border-neutral-800 sm:p-8">
          <DeactivateInternalTrafficPanel />
        </div>
      </div>
      <Footer />
    </>
